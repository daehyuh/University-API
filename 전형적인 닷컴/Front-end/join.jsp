...
<body>
	...
	<div class="inner-wrap">
		<div class="logo">
			<a href="/index.jsp" title="홈페이지 바로가기">전형닷컴</a>
		</div>
		<%
						...
						<table>
							...
							<tbody>
									...
									<td>
										<div class="input-btn-type-word-5 w460px">
											<input onchange="check(this, 8, 2)" id="um_password"
												name="um_password" title="비밀번호 입력" class="input-text w340px"
								...
								<tr>
									...
									<td>
										<div class="input-btn-type-word-5 w460px">
											<input onchange="pwcheck(this)" id="um_password_check"
												name="um_password_check" title="비밀번호 확인 입력"
